...
```{r}
# Read and merge data
camels <- map(remote_files, readr::read_delim, show_col_types = FALSE) |> 
...
Rec_Prep <- prep(rec, training = camels_train)

Rec_Bake <- bake(Rec_Prep, new_data = camels_test)
...
dim(Camels_Test)
```
> Proper splitting of the data was performed.
